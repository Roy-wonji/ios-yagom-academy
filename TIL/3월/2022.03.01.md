...
뷰 컨트롤러에 있는  `오토레이아웃 `에 대해서 이해및 공부를 하고 구현을 했습니다!. </br>
...
> (참조: [translatesAutoresizingMaskIntoConstraints](https://developer.apple.com/documentation/uikit/uiview/1622572-translatesautoresizingmaskintoco))
>
</br>

![](https://i.imgur.com/ex56ioN.png)
...
#### filePrivate 
> 키워드는 거의 동일하지만 사용 사례에서 분명한 차이가 있습니다. Fileprivate 액세스는 정의된 동일한 소스 파일 내에서 엔티티 사용을 제한합니다. fileprivate를 사용하는 유일한 이유는 다른 클래스나 구조체에서 동일한 파일 내의 코드에 액세스하려는 경우입니다.


### ⛺️TIL summary 
1. 오토레이아웃 에 대해 이해 및 정보 정리
2. private 에 대한 이해
...
### ⛺️ 문제점 / 고민한 점 / 느낀점 
- 오토레이 아웃에 대해 이해 
- private 과 fileprivate 에 대한 이해
-  모른는 개념을 조금더 집어가고 왜 라는 질문을 자주 던져 보자!!


### ⛺️ 참고 자료 
- [Auto Layout 공식문서](https://developer.apple.com/library/archive/documentation/UserExperience/Conceptual/AutolayoutPG/index.html#//apple_ref/doc/uid/TP40010853-CH7-SW1)
- [ 접근 제어 공식문서](https://jusung.gitbook.io/the-swift-language-guide/language-guide/25-access-control)
- [privat vs fileprivate 참고 자료 ](https://www.avanderlee.com/swift/fileprivate-private-differences-explained/)


[다음 TIL 보기 ](https://github.com/Roy-wonji/ios-yagom-academy/blob/main/TIL/3월/2022.03.03.md)
